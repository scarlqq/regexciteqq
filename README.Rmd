...
The goal of regexciteqq is to make regular expressions more exciting!
...
You can install the released version of regexciteqq from [GitHub](https://github.com/) with:
